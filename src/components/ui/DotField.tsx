...
const DotField = memo(
  ({
    ...
    sparkle = false,
    waveAmplitude = 0,
    gradientFrom = "rgba(99, 102, 241, 0.35)", // Indigo-500 equivalent
    gradientTo = "rgba(168, 85, 247, 0.25)",   // Purple-500 equivalent
    ...
    // Update props reference so effect callbacks use latest parameters
    propsRef.current = {
      dotRadius,
      dotSpacing,
      cursorRadius,
        ...
        for (let i = 0; i < len; i++) {
          ...
          if (distSq < crSq && eng > 0.01) {
            ...
            if (isBulge) {
              ...
              const push = term * term * p.bulgeStrength * eng;
